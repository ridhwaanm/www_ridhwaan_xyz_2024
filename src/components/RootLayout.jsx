  ...
  return (
    <nav className="mt-px font-display text-5xl font-medium tracking-tight text-white">
      <NavigationRow>
        ...
        <NavigationItem href="/about">About Ridhwaan</NavigationItem>
      </NavigationRow>
      <NavigationRow>
