    ...
    <>
      ...
      <Container className="mt-16 sm:mt-32">
        <div className="prose prose-slate max-w-3xl mx-auto">
          <h2>Introduction</h2>
          <p>
            Welcome to the Quran Reader App ("App") developed by Ridhwaan Mayet. This Privacy Policy 
            is designed to help you understand how we handle information when you use our App.
          </p>

          <h2>Summary</h2>
          <p className="font-semibold">
            The Quran Reader App does not collect, store, or transmit any personal data.
          </p>
          <p>
            We've designed this App with privacy as a fundamental principle. The App functions entirely 
            locally on your device and doesn't require an internet connection for its core functionality.
          </p>
          ...
          <h2>Local Storage</h2>
          <p>
            Any preferences or settings you configure in the App (such as navigation bar visibility) 
            are stored locally on your device and are never transmitted to us or any third parties.
          </p>

          <h2>Changes to the App</h2>
          <p>
            If future versions of the App introduce any features that might impact your privacy, 
            this Privacy Policy will be updated accordingly, and you will be notified within the App.
          </p>

          <h2>Open Source Commitment</h2>
          <p>
            The Quran Reader App is fully open source. All code is available for review at{' '}
            <a href="https://github.com/ridhwaanm/quran" target="_blank" rel="noopener noreferrer">
              https://github.com/ridhwaanm/quran
            </a>
            . This transparency ensures that our privacy claims can be independently verified.
          </p>
